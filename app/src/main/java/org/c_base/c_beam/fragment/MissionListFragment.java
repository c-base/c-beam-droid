...
public class MissionListFragment extends ListFragment {
	private final ArrayList<Mission> items = new ArrayList<>();
	...
	private static class MissionAdapter extends ArrayAdapter<Mission> {
		private final ArrayList<Mission> items;

		public MissionAdapter(Context context, int itemLayout, ArrayList<Mission> items) {

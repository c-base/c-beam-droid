...
public class C_beamAppWidgetProvider extends AppWidgetProvider {
	...
	public void onEnabled(Context context) {
		Log.d(TAG, "onEnabled");
		// This used to toggle a C_beamBroadcastReceiver that was never registered in the
		// manifest and that nothing ever sent a broadcast to; the receiver has been removed.
	}
